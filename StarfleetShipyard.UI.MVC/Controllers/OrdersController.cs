...
namespace StarfleetShipyard.UI.MVC.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(StarfleetShipyardContext context)
        {
            _context = context;
        }
        ...
        {
            var StarfleetShipyardContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate")] Order order)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.CustomerDetails, "CustomerId", "CustomerId", order.CustomerId);
            return View(order);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StarfleetShipyardContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
